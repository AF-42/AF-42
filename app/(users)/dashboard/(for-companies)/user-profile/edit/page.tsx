...
import {
    ArrowLeft, Briefcase, Building2, Mail, MapPin, Save, Upload, X
} from 'lucide-react';
...
export default function EditUserProfilePage() {
    ...
    const [userData, setUserData] = useState<UserProfileType | undefined>(null);
                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="absolute -bottom-1 -right-1">
                                                ...
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        return document.querySelector('#avatar-upload')?.click();
                                                    }}
                                                >
