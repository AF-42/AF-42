...
const datasets = [
    ...
    },
    {
        key  : 'blockchain',
        name : 'Blockchain',
        data : blockchainDataset
    },
    {
        key  : 'cryptography',
        name : 'Cryptography',
        data : cryptographyDataset
    },
    {
        key  : 'cybersecurity',
        name : 'Cybersecurity',
        data : cybersecurityDataset
    },
    {
        key  : 'dataScience',
        name : 'Data Science',
        data : dataScienceDataset
    },
    {
        key  : 'database',
        name : 'Database',
    ...
    },
    {
        key  : 'generativeAi',
        name : 'Generative AI',
        data : generativeAiDataset
    },
    {
        key  : 'graphics',
        name : 'Graphics',
        data : graphicsDataset
    },
    {
        key  : 'hardware',
        name : 'Hardware & Low-level',
    ...
    },
    {
        ...
        data : languagesDataset
    },
    {
        key  : 'machineLearning',
        name : 'Machine Learning',
        data : machineLearningDataset
    },
    {
        key  : 'mobile',
    ...
    },
    {
        ...
        name : 'Programming Languages',
        data : programingLanguagesDataset
    },
    {
        key  : 'webDevelopment',
        name : 'Web Development',
        data : webDevelopmentDataset
    },
    {
        key  : 'web3',
        name : 'Web3',
...
type CategoryData = Record<string, DatasetItem[] | DatasetItem | any>;

// Props interface for the component
type DataSelectionComponentProps = {
...
export const DataSelectionComponent = ({ onJsonChange }: DataSelectionComponentProps = {}) => {
    ...
    const generateOutput = (keys: string[]) => {
        ...
        for (const key of keys) {
            ...
            if (dataset?.data && (dataset.data as any)[categoryKey]) {
                output[datasetKey] ||= {};
                ...
                if (itemIndex === undefined) {
                    ...
                    if (Array.isArray(categoryData) && categoryData[Number.parseInt(itemIndex)]) {
                        if (!output[datasetKey][categoryKey]) {
                            output[datasetKey][categoryKey] = [];
                        }
                        output[datasetKey][categoryKey].push(categoryData[Number.parseInt(itemIndex)]);
                    }
                }
            }
        }
            ...
            <div className="grid grid-cols-2 gap-6 pb-6">
                ...
                <Card className="">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Search and select categories from {datasets.find((d) => {
                                return d.key === selectedDataset;
                            })?.name}
                        </CardDescription>
                    </CardHeader>
                                ...
                                {selectedKeys.map((key) => {
                                    ...
                                    if (itemIndex !== undefined) {
                                        ...
                                        const item = Array.isArray(categoryData)
                                            ? categoryData[Number.parseInt(itemIndex)]
                                            : null;
                                        return (
