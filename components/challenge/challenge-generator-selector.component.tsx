		...
		<div className="w-full max-w-7xl mx-auto space-y-6">
			...
			<Card className="border-none">
				<CardHeader className="border-none">
					...
					<CardDescription>
						Upload a job description file (PDF, DOCX, TXT) and let our AI extract the technical requirements
						automatically. Perfect for when you have a complete job posting document.
					</CardDescription>
				</CardHeader>
