...
export function TaskGeneratorFormFromDataSelection() {
    ...
    const [translationError, setTranslationError] = useState<string | undefined>(null);
    const [isExtractingTechStack, setIsExtractingTechStack] = useState<boolean>(false);
    const [techStackError, setTechStackError] = useState<string | undefined>(null);
    const [extractedTechStack, setExtractedTechStack] = useState<StackSelectionJson | undefined>(null);
