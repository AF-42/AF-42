...
const pathToBreadcrumbs: Record<string, BreadcrumbItem[]> = {
	...
	'/dashboard/company-profile': [{ label: 'Dashboard', href: '/dashboard' }, { label: 'Company Profile' }],
	'/dashboard/members': [{ label: 'Dashboard', href: '/dashboard' }, { label: 'Members' }],
	'/dashboard/user-profile': [{ label: 'Dashboard', href: '/dashboard' }, { label: 'User Profile' }],
	'/challenge': [{ label: 'Challenges', href: '/challenge' }],
	'/challenge/challenge-board': [{ label: 'Challenges', href: '/challenge' }, { label: 'Challenge Board' }],
	'/challenge/my-challenges': [{ label: 'Challenges', href: '/challenge' }, { label: 'My Challenges' }],
	'/challenge/my-challenges/ongoing': [
		{ label: 'Challenges', href: '/challenge' },
		{ label: 'My Challenges', href: '/challenge/my-challenges' },
		{ label: 'Ongoing' },
	],
	...
	'/challenge/generate': [{ label: 'Challenges', href: '/challenge' }, { label: 'Generate Challenge' }],
	'/challenge/published': [{ label: 'Challenges', href: '/challenge' }, { label: 'Published Challenges' }],
	'/challenge/candidates': [{ label: 'Challenges', href: '/challenge' }, { label: 'Candidates' }],
};
